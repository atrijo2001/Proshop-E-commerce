import { USER_LOGIN_REQUEST,USER_LOGIN_SUCCESS, USER_LOGIN_FAIL, USER_LOGOUT, USER_REGISTER_SUCCESS, USER_REGISTER_FAIL, USER_REGISTER_REQUEST,
...
export const register = (name, email, password) => async(dispatch)=> {
    try {
        ...
        //Login the user right away once they register
        dispatch({
            type: USER_LOGIN_SUCCESS,
            payload: data,
        })
